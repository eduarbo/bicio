...
define('bicio/components/map-box', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el5 = dom.createTextNode("La mejor app para ciclistas urbanos");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        ...
        var el4 = dom.createTextNode("Categorias");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        ...
        var el6 = dom.createTextNode("Aqui");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n      ");
        ...
        var el5 = dom.createElement("a");
        dom.setAttribute(el5,"href","#");
        var el6 = dom.createTextNode("van");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n      ");
        ...
        var el5 = dom.createElement("a");
        dom.setAttribute(el5,"href","#");
        var el6 = dom.createTextNode("Varios");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n      ");
        ...
        var el5 = dom.createTextNode("Ruta destacada");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n      ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("p");
        var el5 = dom.createTextNode("Pork drumstick turkey fugiat. Tri-tip elit turducken pork chop in. Swine short ribs meatball irure bacon nulla pork belly cupidatat meatloaf cow.");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n      ");
        dom.appendChild(el3, el4);
...
define('bicio/templates/components/map-box', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "bicio/templates/components/map-box.hbs"
      },
      isEmpty: false,
      arity: 0,
      cachedFragment: null,
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Hola, soy un mapa");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n");
        dom.appendChild(el0, el1);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Create your route");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n");
        dom.appendChild(el0, el1);
      ...
      statements: [
        ["content","map-box",["loc",[null,[2,0],[2,11]]]]
      ],
      locals: [],
      templates: []
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("This is \"routes\" template");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n\n");
        dom.appendChild(el0, el1);
...
if (runningTests) {
  ...
  require("bicio/app")["default"].create({"name":"bicio","version":"0.0.0+be79a282"});
}

/* jshint ignore:end */
//# sourceMappingURL=http://eduarbo.github.io/bicio/assets/bicio-9f7762e8307f9ccfc226a46e08e32f1f.map